    ...
    <div class="card-body">
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted">Chưa có học viên. <a href="{{ route('admin.centers.classes.students.create', [$center, $center_class]) }}">Thêm học viên</a> hoặc <a href="{{ route('admin.centers.classes.students.import', [$center, $center_class]) }}">Import Excel</a></td>
                    </tr>
                @endforelse
            </tbody>
        </table>
